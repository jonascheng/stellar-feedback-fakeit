...
type Server struct {
	...
	SKU            string             `json:"sku" xml:"sku" fake:"{randomstring:[TES1ZAEXX,TES1ZAEXY,TES1ZAEXZ]}"`
	AC             string             `json:"ac" xml:"ac" fake:"{regex:[A-Z,0-9]{32}}"`
	Volume         []ServerVolumeInfo `json:"volume" xml:"volume" fakesize:"5"`
